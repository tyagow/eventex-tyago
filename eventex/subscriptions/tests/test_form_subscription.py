...
class SubscriptionFormTest(TestCase):
    ...
    def test_cpf_is_digit(self):
        ...
        form = self.make_validated_form(cpf='1234abc8901')
    ...
    def test_name_must_be_captalized(self):
        ...
        form = self.make_validated_form(name='TIAGO zoeira')
        self.assertEqual('Tiago Zoeira', form.cleaned_data['name'])
    ...
    def make_validated_form(self, **kwargs):
        valid = dict(name='Tiago Almeida', cpf='12345678901',
                    email='tyagow@hotmail.com.br', phone='48-9142-0350')
